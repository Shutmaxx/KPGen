...
segment_value — характеристика компании в её отрасли, 1-2 предложения.
  Первое предложение продолжает название компании и описывает, чем она
  занимается и какое место занимает в своей отрасли. Второе предложение —
  о значимости её продукции или услуг для рынка и партнёров.
  Отрасль компании: {industry} — опирайся строго на неё, не придумывай
  другую сферу деятельности.
  Начни со слов «является» или «— один из».
  НЕ упоминай регион, город и адрес.
  Пиши уважительно и по-деловому, без превосходных степеней вроде
  «самый лучший» и без выдуманных фактов: наград, оборотов, дат основания.
...
our_offer — что мы можем и готовы предложить именно под эти потребности.
  Начни строго со слов «Также мы можем предложить». Пиши на «Вы»,
  2-3 предложения, конкретно и без общих слов.
